...
public class DashboardP11GeralController implements Initializable {
    @FXML
    ...
    @FXML
    private void onPrimeiroTrimestreButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP11.1.fxml");
    }

    @FXML
    private void onSegundoTrimestreButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP11.2.fxml");
    }

    @FXML
    private void onTerceiroTrimestreButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP11.3.fxml");
    }

    @FXML
    private void onQuartoTrimestreButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP11.4.fxml");
    }
    ...
    private void navigateTo(String fxmlPath) {
        try {
            ...
            else if (controller instanceof DashboardP11Ponto1Controller) {
                ((DashboardP11Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP11Ponto2Controller) {
                ((DashboardP11Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP11Ponto3Controller) {
                ((DashboardP11Ponto3Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP11Ponto4Controller) {
                ((DashboardP11Ponto4Controller) controller).setUtilizador(utilizador);
            }
