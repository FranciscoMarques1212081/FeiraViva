...
public class DashboardP1GeralController implements Initializable {
    ...
    @FXML
    private void onEficienciaOrganizacionalButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP1.1.fxml");
    }

    @FXML
    private void onReceitasPropriasButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP1.2.fxml");
    }

    @FXML
    private void onSatisfacaoColaboradoresButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP1.3.fxml");
    }
    ...
    private void navigateTo(String fxmlPath) {
        try {
            ...
            if (controller instanceof HomePageController) {
                ...
                ((DashboardAdministratorController) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP1Ponto1Controller) {
            ((DashboardP1Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP1Ponto2Controller) {
            ((DashboardP1Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP1Ponto3Controller) {
            ((DashboardP1Ponto3Controller) controller).setUtilizador(utilizador);
        }
