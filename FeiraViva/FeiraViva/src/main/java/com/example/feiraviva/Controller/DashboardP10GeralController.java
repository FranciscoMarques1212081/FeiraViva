...
public class DashboardP10GeralController implements Initializable {
    @FXML
    ...
    @FXML
    private void onProcessosAdjudicacao1ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP10.1.fxml");
    }

    @FXML
    private void onProcessosAdjudicacao2ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP10.2.fxml");
    }
    ...
    private void navigateTo(String fxmlPath) {
        try {
            ...
            else if (controller instanceof DashboardP10Ponto1Controller) {
                ((DashboardP10Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP10Ponto2Controller) {
                ((DashboardP10Ponto2Controller) controller).setUtilizador(utilizador);
            }
