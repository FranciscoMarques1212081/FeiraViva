...
public class DashboardP8GeralController implements Initializable {
    ...
    private void onSatisfacaoClientes1ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP8.1.1.fxml");
    }

    @FXML
    private void onSatisfacaoClientes2ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP8.1.2.fxml");
    }

    @FXML
    private void onResultadoLiquidoButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP8.2.fxml");
    }

    @FXML
    private void onOfertaEventosButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP8.3.fxml");
    }

    @FXML
    private void onSucessoEvento1ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP8.4.1.fxml");
    }

    @FXML
    private void onSucessoEvento2ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP8.4.2.fxml");
    }

    @FXML
    private void onSucessoEvento3ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP8.4.3.fxml");
    }
    ...
    private void navigateTo(String fxmlPath) {
        try {
            ...
            else if (controller instanceof DashboardP8Ponto1Ponto1Controller) {
                ((DashboardP8Ponto1Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP8Ponto1Ponto2Controller) {
                ((DashboardP8Ponto1Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP8Ponto2Controller) {
                ((DashboardP8Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP8Ponto3Controller) {
                ((DashboardP8Ponto3Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP8Ponto4Ponto1Controller) {
                ((DashboardP8Ponto4Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP8Ponto4Ponto2Controller) {
                ((DashboardP8Ponto4Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP8Ponto4Ponto3Controller) {
                ((DashboardP8Ponto4Ponto3Controller) controller).setUtilizador(utilizador);
            }
