...
public class DashboardP5GeralController implements Initializable {
    @FXML
    ...
    private void onOfertaEventosButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP5.1.fxml");
    }

    @FXML
    private void onDivulgacaoMarcasButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP5.2.fxml");
    }

    @FXML
    private void onUtilizadoresSeguidoresButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP5.3.fxml");
    }

    @FXML
    private void onUtilizadoresSeguidores1ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP5.3.2.fxml");
    }
    ...
    private void navigateTo(String fxmlPath) {
        try {
            ...
            else if (controller instanceof DashboardP5Ponto1Controller) {
                ((DashboardP5Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP5Ponto2Controller) {
                ((DashboardP5Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP5Ponto3Controller) {
                ((DashboardP5Ponto3Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP5Ponto3Ponto2Controller) {
                ((DashboardP5Ponto3Ponto2Controller) controller).setUtilizador(utilizador);
            }
