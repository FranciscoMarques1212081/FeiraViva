...
public class DashboardP2GeralController implements Initializable {

    @FXML
    private Button homepageButton, dashboardButton, settingsButton, logoutButton;

    @FXML
    private TextArea excelTextArea;
    ...
    @FXML
    private void onAvaliacaoDesempenhoButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP2.1.fxml");
    }

    @FXML
    private void onAccoesFormacao1ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP2.2.1.fxml");
    }

    @FXML
    private void onAccoesFormacao2ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP2.2.2.fxml");
    }

    @FXML
    private void onDinamicaGrupoButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP2.3.fxml");
    }
    ...
    private void navigateTo(String fxmlPath) {
        try {
            ...
            else if (controller instanceof DashboardP2Ponto1Controller) {
                ((DashboardP2Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP2Ponto2Ponto1Controller) {
                ((DashboardP2Ponto2Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP2Ponto2Ponto2Controller) {
                ((DashboardP2Ponto2Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP2Ponto3Controller) {
                ((DashboardP2Ponto3Controller) controller).setUtilizador(utilizador);
            }
