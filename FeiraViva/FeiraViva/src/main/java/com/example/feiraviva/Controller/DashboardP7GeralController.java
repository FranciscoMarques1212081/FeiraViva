...
public class DashboardP7GeralController implements Initializable {
    ...
    @FXML
    private void onSatisfacaoVisitantes1ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP7.1.1.fxml");
    }

    @FXML
    private void onSatisfacaoVisitantes2ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP7.1.2.fxml");
    }

    @FXML
    private void onConservacaoAnimalButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP7.2.fxml");
    }

    @FXML
    private void onResultadoLiquidoButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP7.3.fxml");
    }

    @FXML
    private void onNumeroVisitantesButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP7.4.fxml");
    }
    ...
    private void navigateTo(String fxmlPath) {
        try {
            ...
            else if (controller instanceof DashboardP7Ponto1Ponto1Controller) {
                ((DashboardP7Ponto1Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP7Ponto1Ponto2Controller) {
                ((DashboardP7Ponto1Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP7Ponto2Controller) {
                ((DashboardP7Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP7Ponto3Controller) {
                ((DashboardP7Ponto3Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP7Ponto4Controller) {
                ((DashboardP7Ponto4Controller) controller).setUtilizador(utilizador);
            }
