...
public class DashboardP6GeralController implements Initializable {
    @FXML
    ...
    @FXML
    private void onClientesAtivosButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP6.1.fxml");
    }

    @FXML
    private void onSatisfacaoUtentes1ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP6.2.1.fxml");
    }

    @FXML
    private void onSatisfacaoUtentes2ButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP6.2.2.fxml");
    }

    @FXML
    private void onAumentarRendabilidadeButtonClick() {
        navigateTo("/com/fxml/feiraviva/DashboardP6.3.fxml");
    }
    ...
    private void navigateTo(String fxmlPath) {
        try {
            ...
            else if (controller instanceof DashboardP6Ponto1Controller) {
                ((DashboardP6Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP6Ponto2Ponto1Controller) {
                ((DashboardP6Ponto2Ponto1Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP6Ponto2Ponto2Controller) {
                ((DashboardP6Ponto2Ponto2Controller) controller).setUtilizador(utilizador);
            } else if (controller instanceof DashboardP6Ponto3Controller) {
                ((DashboardP6Ponto3Controller) controller).setUtilizador(utilizador);
            }
